  ...
  <div>
    ...
    <div class="work-container my-5">
      <div class="img-container hover-zoom">
        <a href="https://hootstory.com/" target="_blank">
          <img
            class="work-img"
      ...
      <div class="work-desc-container">
        <h3>Hootstory</h3>
        <div class="work-desc">
          A story posting web-app developing for BiTechX. I worked for both
          frontend and backend with the BiTechX team.
        </div>
        <div class="made-with">
          <div>Made with</div>
          NuxtJS | Laravel | AWS
    ...
    <div class="work-container my-5">
      ...
      <div class="work-desc-container">
        <h3>Music Player</h3>
        <div class="work-desc">
          It's a prototype web-application to test Progressive Web App(PWA)
          technology.
        </div>
        <div class="made-with">
          <div>Made with</div>
          HTML5 | CSS | JavaScript | PWA
        </div>
      </div>
    </div>

    <div class="text-center mb-5">
      <NuxtLink to="/works" tag="div" class="btn btn-secondary"
        >View more</NuxtLink
      >
    </div>
  </div>
...
/* For Odd styles */
.work-container:nth-child(odd) .img-container {
  order: 2;
}
.work-container:nth-child(odd) .work-desc {
  left: unset;
  right: -100px;
}
.work-container:nth-child(odd) .work-desc-container {
  text-align: left;
  margin-left: 0px;
  margin-right: 20px;
}
